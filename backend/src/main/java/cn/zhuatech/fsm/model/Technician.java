...
@Entity @Table(name="fsm_technician") public class Technician extends BaseEntity {
    ...
    protected Technician(){} /**
                              * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                              */
public Technician(String code,String name,ServiceRegion serviceRegion,Status status,int oee){this.code=code;this.name=name;this.serviceRegion=serviceRegion;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
...
public String getName(){return name;} /**
                                                                                 * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                 */
public ServiceRegion getServiceRegion(){return serviceRegion;} /**
                                                                                                                                                * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                                                                                */
