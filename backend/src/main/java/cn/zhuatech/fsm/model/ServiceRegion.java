...
@Entity @Table(name="fsm_service_region") public class ServiceRegion extends BaseEntity {
    ...
    protected ServiceRegion(){} public ServiceRegion(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
